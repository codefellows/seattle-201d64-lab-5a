...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var multiplyFirstTwoNumbers = multiply(multArr[0], multArr[1])[0];
  // console.log(multiplyFirstTwoNumbers);
  var multiplyAllThreeNumbers = multiply(multiplyFirstTwoNumbers, multArr[2])[0];
  // console.log(multiplyAllThreeNumbers);
  //now i know that var multiplyAllThreeNumbers is equal to 24


  var secondElementStringWithNumbers = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multiplyAllThreeNumbers + '.';
  var questionFiveArray = [multiplyAllThreeNumbers, secondElementStringWithNumbers];
  return questionFiveArray;
}
