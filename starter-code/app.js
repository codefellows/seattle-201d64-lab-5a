...
function sumArray(sumArr) { //eslint-disable-line
  ...
  // console.log('test sum01:', sum01[0]);
  var sum012 = sum(sum01[0],testArray[2]);
  // console.log('test sum012:', sum012[0]);
  var endSumArr = sum012[0];
  // console.log('test endSumArr:', endSumArr);

  var stringArr = (testArray[0] + ','+ testArray[1] +','+ testArray[2] +' was passed in as an array of numbers, and '+ endSumArr +' is their sum.')
  // console.log('test stringArr:', stringArr);

  return [endSumArr, stringArr];
...
function multiplyArray(multArr) { //eslint-disable-line
  var arrayABProduct = multiply(testArray[0],testArray[1]);
  // console.log('arrayABProduct =', arrayABProduct);
  var aBProduct = arrayABProduct[0];
  // console.log('aBProduct =', aBProduct);

  var arrayProduct = multiply(aBProduct, testArray[2]);
  // console.log('arrayProduct =', arrayProduct);
  var productOfArray = arrayProduct[0];
  // console.log('productOfArray =', productOfArray);


  var stringArrayProduct = ('The numbers '+ testArray[0] +','+ testArray[1] +','+ testArray[2] +' have a product of '+ productOfArray + '.');
  // console.log('stringArrayProduct =', stringArrayProduct);

  return [productOfArray, stringArrayProduct];
}
